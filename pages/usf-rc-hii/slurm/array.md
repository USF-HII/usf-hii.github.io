...
For a job which has a small number of variations (e.g. 10 different input files), a normal Slurm job may be appropriate, but when variations number in the hundreds to hundreds, thousands, or beyond a Slurm job array is the preferred solution.
